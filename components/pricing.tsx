...
const plans: PricingPlan[] = [
  {
    ...
    icon: Rocket,
    features: [
      "Full IDE with local model support",
  ...
  },
  {
    ...
    price: "$10",
    period: "/mo",
    note: "Per seat, cancel anytime",
    icon: Zap,
    features: [
      "Everything in Free",
      "Cloud model access (OpenAI, Anthropic, Gemini)",
      "Agents Window — multi-repo orchestration",
      "Team workspaces & shared rules",
      "Priority support",
      "Usage-based cloud credits included",
    ],
    cta: "Start Pro trial",
    popular: true,
  },
